...
/**
* Protege name: http://www.owl-ontologies.com/Ontology1529152759.owl#VerterAgua
* @author OntologyBeanGenerator v4.1
* @version 2018/06/18, 13:01:05
*/
public class DefaultVerterAgua implements VerterAgua {

  private static final long serialVersionUID = 3688839762589084456L;

  private String _internalInstanceName = null;

  public DefaultVerterAgua() {
    this._internalInstanceName = "";
  }

  public DefaultVerterAgua(String instance_name) {
