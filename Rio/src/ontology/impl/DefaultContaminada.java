...
/**
* Protege name: http://www.owl-ontologies.com/Ontology1529152759.owl#Contaminada
* @author OntologyBeanGenerator v4.1
* @version 2018/06/18, 13:01:05
*/
public class DefaultContaminada implements Contaminada {

  private static final long serialVersionUID = 3688839762589084456L;

  private String _internalInstanceName = null;

  public DefaultContaminada() {
    this._internalInstanceName = "";
  }

  public DefaultContaminada(String instance_name) {
